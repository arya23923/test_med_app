...
import AppointmentFormAB from '../AppointmentFormAB/AppointmentFormAB'
import { v4 as uuidv4 } from 'uuid';

const DoctorCardAB = ({ name, speciality, experience, ratings, profilePic }) => {
          ...
          {(close) => (
            <div className="doctorbg" style={{ height: '100vh', overflow: 'scroll' }}>
              ...
              {appointments.length > 0 ? (
                ...
                <AppointmentFormAB doctorName={name} doctorSpeciality={speciality} onSubmit={handleFormSubmit} />
              )}
            </div>
          )}
        </Popup> 
